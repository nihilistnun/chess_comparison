...
Game::Game(int setup)
{
	...
	{
	case 0: {
		const char temp_board[8][8] =
		{
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 'K', 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 'p', 0x20 },
		{ 0x20, 0x20, 'r', 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 'P', 0x20, 'q', 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 'Q', 0x20 },
		{ 'P', 'k', 0x20, 0x20, 0x20, 'p', 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 'R', 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		};
		memcpy(initial_board, temp_board, sizeof(char) * 8 * 8);
		break;
	}
	case 1: {
		const char temp_board[8][8] =
	...
	case 2: {
		...
		{ 0x20, 'P', 0x20, 0x20, 0x20, 0x20, 0x20, 'p' },
		{ 0x20, 0x20, 0x20, 'p', 0x20, 0x20, 0x20, 0x20 },
		{ 'p', 'P', 0x20, 0x20, 0x20, 'k', 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 'p', 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 'P', 0x20 },
		{ 0x20, 0x20, 'b', 0x20, 0x20, 0x20, 'R', 0x20 },
		};
		memcpy(initial_board, temp_board, sizeof(char) * 8 * 8);
		break;
	}
	case 3: {
		...
		{ 0x20, 'p', 0x20, 0x20, 'p', 'K', 0x20, 0x20 },
		{ 0x20, 0x20, 'b', 0x20, 0x20, 'p', 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 'R', 0x20, 0x20, 'B', 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
	...
	case 4: {
		...
		{
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 'p', 0x20, 0x20, 0x20, 0x20, 0x20, 'P', 0x20 },
		{ 0x20, 0x20, 0x20, 'K', 0x20, 0x20, 'P', 0x20 },
		{ 0x20, 'k', 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
	...
	case 5: {
		const char temp_board[8][8] =
		{
		{ 0x20, 0x20, 0x20, 'B', 'K', 'n', 0x20, 'k' },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 'Q', 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 'p', 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 'q', 'b', 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		{ 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
		};
		memcpy(initial_board, temp_board, sizeof(char) * 8 * 8);
		break;
...
//returns the value of a piece type based on player side
int Game::pieceValue(int row, int col) const
{
	char piece = board[row][col];// 00 is A1
	if (piece == 0x20)
		return 0;
	int value = isupper(piece) ? 1 : -1;
	switch (tolower(piece))//capital is white
	{
	case 'p':
		value *= 10;
		break;
